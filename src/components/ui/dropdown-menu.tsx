...
>(({ className, inset, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      {children}
      {dir === "rtl" ? <ChevronLeft className="mr-auto" /> : <ChevronRight className="ml-auto" />} {/* Adjusted for RTL */}
    </DropdownMenuPrimitive.SubTrigger>
  )
})
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("text-xs tracking-widest opacity-60", dir === "rtl" ? "mr-auto" : "ml-auto", className)} // Adjusted for RTL
      {...props}
    />
  )
}
