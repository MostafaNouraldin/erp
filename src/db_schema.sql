...
-- Main schema for system administration
...
-- Sales and Purchases Transactional Tables
...
-- Accounting Transactional Tables
...
ALTER TABLE "insurance_classes" ADD CONSTRAINT "insurance_classes_company_id_insurance_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "insurance_companies"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "employee_deductions" ADD CONSTRAINT "employee_deductions_type_id_deduction_types_id_fk" FOREIGN KEY ("type_id") REFERENCES "deduction_types"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "sales_invoices" ADD CONSTRAINT "sales_invoices_customer_id_customers_id_fk" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE no action ON UPDATE no action;
...
-- Default Super Admin credentials: super@admin.com / superadmin_password
-- Default Tenant Admin credentials: manager@example.com / password
INSERT INTO "roles" ("id", "name", "description", "permissions") VALUES
('ROLE_SUPER_ADMIN', 'Super Admin', 'Full system access, including tenant and module management.', '["admin.manage_tenants", "admin.manage_modules", "admin.manage_billing", "admin.manage_requests"]'::jsonb),
('ROLE001', 'مدير النظام', 'صلاحيات كاملة على النظام.', '["accounting.view", "accounting.create", "accounting.edit", "accounting.delete", "accounting.approve", "sales.view", "sales.create", "sales.edit", "sales.delete", "sales.send_quote", "inventory.view", "inventory.create", "inventory.edit", "inventory.delete", "inventory.adjust_stock", "hr.view", "hr.create_employee", "hr.edit_employee", "hr.run_payroll", "reports.view_financial", "reports.view_sales", "reports.view_inventory", "reports.view_hr", "settings.view", "settings.edit_general", "settings.manage_users", "settings.manage_roles", "projects.view", "projects.create", "projects.edit", "projects.delete", "production.view", "production.create", "production.edit", "production.delete", "pos.use"]'::jsonb),
...
-- Insert default system users (Super Admin and an example Tenant Admin)
INSERT INTO "users" ("id", "name", "email", "role_id", "password_hash") VALUES
('USER_SUPER_ADMIN', 'Super Admin', 'super@admin.com', 'ROLE_SUPER_ADMIN', 'hashed_superadmin_password'),
('USER001', 'أحمد محمود', 'manager@example.com', 'ROLE001', 'hashed_password');

-- Insert a default tenant for initial setup
INSERT INTO "tenants" ("id", "name", "email") VALUES ('T001', 'شركة المستقبل التجريبية', 'contact@almustaqbal.com');
...
('11', 'النقدية وما يعادلها', 'فرعي', '10'),
('111', 'الصندوق', 'فرعي', '11'),
('1111', 'صندوق نقاط البيع', 'تحليلي', '111'),
('1112', 'الخزينة الرئيسية', 'تحليلي', '111'),
('112', 'البنوك', 'فرعي', '11'),
('1121', 'بنك الرياض', 'تحليلي', '112'),
('12', 'الذمم المدينة', 'فرعي', '10'),
('1200', 'العملاء (الذمم المدينة)', 'تحليلي', '12'),
('1210', 'سلف الموظفين', 'تحليلي', '12'),
('13', 'المخزون', 'فرعي', '10'),
('1300', 'المخزون السلعي', 'تحليلي', '13'),
('2', 'الخصوم', 'رئيسي', NULL),
('20', 'الخصوم المتداولة', 'فرعي', '2'),
('2010', 'الموردون (الذمم الدائنة)', 'تحليلي', '20'),
('2100', 'رواتب مستحقة', 'تحليلي', '20'),
('2110', 'خصومات مستحقة', 'تحليلي', '20'),
('2200', 'ضريبة القيمة المضافة المستحقة', 'تحليلي', '20'),
('3', 'حقوق الملكية', 'رئيسي', NULL),
('3000', 'رأس المال', 'تحليلي', '3'),
('3100', 'الأرباح المحتجزة', 'تحليلي', '3'),
('4', 'الإيرادات', 'رئيسي', NULL),
('4000', 'إيرادات المبيعات', 'تحليلي', '4'),
('4100', 'مردودات المبيعات', 'تحليلي', '4'),
('5', 'المصروفات', 'رئيسي', NULL),
('5000', 'مصروف الرواتب والأجور', 'تحليلي', '5'),
('5010', 'مصروف البدلات', 'تحليلي', '5'),
('5100', 'مصاريف عمومية وإدارية', 'تحليلي', '5'),
('5200', 'مصاريف تسويق وبيع', 'تحليلي', '5'),
('5300', 'مصاريف تشغيلية', 'فرعي', '5'),
('5301', 'مصروف كهرباء', 'تحليلي', '5300'),
('5302', 'مصروف مياه', 'تحليلي', '5300'),
('5303', 'عجز/زيادة الصندوق', 'تحليلي', '5300');

-- Insert initial HR settings data
INSERT INTO "departments" ("id", "name") VALUES
('DEP001', 'الإدارة العامة'),
('DEP002', 'المبيعات والتسويق'),
('DEP003', 'المالية والمحاسبة'),
('DEP004', 'الموارد البشرية'),
('DEP005', 'تقنية المعلومات');
...
('JT004', 'مدير مبيعات'),
('JT005', 'مندوب مبيعات'),
('JT006', 'مدير موارد بشرية');

INSERT INTO "leave_types" ("id", "name") VALUES
('LT001', 'إجازة سنوية'),
('LT002', 'إجازة مرضية'),
('LT003', 'إجازة طارئة'),
('LT004', 'إجازة بدون راتب');

INSERT INTO "allowance_types" ("id", "name", "expense_account_id") VALUES
('ALW001', 'بدل سكن', '5010'),
('ALW002', 'بدل مواصلات', '5010');

INSERT INTO "deduction_types" ("id", "name", "liability_account_id") VALUES
('DED001', 'خصم تأمينات اجتماعية', '2110'),
('DED002', 'سلفة على الراتب', '1210');

INSERT INTO "insurance_companies" ("id", "name") VALUES
('INS001', 'التعاونية للتأمين'),
('INS002', 'بUPA العربية');

INSERT INTO "insurance_classes" ("id", "company_id", "class_name", "description") VALUES
('CLS001', 'INS001', 'VIP', 'تغطية شاملة لكبار الشخصيات'),
('CLS002', 'INS001', 'A', 'تغطية ممتازة للمدراء'),
('CLS003', 'INS002', 'ذهبي', 'تغطية واسعة لجميع الموظفين');

-- Insert a default company setting for currency
INSERT INTO "company_settings" ("id", "settings") VALUES
('T001', '{"defaultCurrency": "SAR", "vatRate": 15, "accountMappings": {"posCashAccount": "1111", "bankAccount": "1121", "accountsReceivable": "1200", "salesRevenue": "4000", "vatPayable": "2200", "cashOverShort": "5303", "salesReturnAccount": "4100"}}'::jsonb);
