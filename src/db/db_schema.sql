...
-- This schema should be applied to the MAIN database for system-wide tables,
-- and also used as the template for each new TENANT database.
...
-- --- Core Tenant-Specific Tables (To be applied on each Tenant DB) ---
