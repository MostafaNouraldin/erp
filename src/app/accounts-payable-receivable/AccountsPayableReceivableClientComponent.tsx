...
import { Users, Briefcase, PlusCircle, Edit, Trash2, FileText, CheckCircle, Search, Filter, Printer, DollarSign } from "lucide-react";
...
}, [customerInvoiceToEdit, customerInvoiceForm]);
...
}, [supplierInvoiceToEdit, supplierInvoiceForm]);
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle>فواتير العملاء المستحقة</CardTitle>
                 <Dialog open={showManageCustomerInvoiceDialog} onOpenChange={setShowManageCustomerInvoiceDialog}>
                    ...
                    <DialogContent className="sm:max-w-xl" dir="rtl">
                        ...
                        <Form {...customerInvoiceForm}>
                            <form onSubmit={customerInvoiceForm.handleSubmit(handleCustomerInvoiceSubmit)} className="space-y-4 py-4">
                                {/* Form fields for customer invoice */}
                                <DialogFooter>
           ...
           <Card className="shadow-md">
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Dialog open={showManageSupplierInvoiceDialog} onOpenChange={setShowManageSupplierInvoiceDialog}>
                    <DialogTrigger asChild>
                     ...
                     <DialogContent className="sm:max-w-xl" dir="rtl">
                        ...
                        <Form {...supplierInvoiceForm}>
                            <form onSubmit={supplierInvoiceForm.handleSubmit(handleSupplierInvoiceSubmit)} className="space-y-4 py-4">
                                {/* Form fields for supplier invoice */}
                                <DialogFooter>
